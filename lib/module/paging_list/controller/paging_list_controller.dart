...
import '../view/paging_list_view.dart';

class PagingListController extends State<PagingListView> {
  static late PagingListController instance;
  late PagingListView view;
